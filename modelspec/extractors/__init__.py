...
# M1: config + safetensors. M2 adds gguf / tokenizer / license (see roadmap).
# The orchestrator runs every extractor whose can_handle() returns True, so a
# GGUF extractor without the optional gguf package simply opts out.
